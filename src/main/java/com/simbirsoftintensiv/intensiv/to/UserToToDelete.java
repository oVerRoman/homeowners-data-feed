...
public class UserToToDelete implements HasId, Serializable {
    ...
    public UserToToDelete(Integer id, Long phone, String email, String firstName, String secondName, String patronymic,
