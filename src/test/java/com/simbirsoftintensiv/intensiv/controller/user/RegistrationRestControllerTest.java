...
//    }
    ...
    /*
     * @Test void registerWithWrongOtPassword() throws Exception { int otPass = otp
     * - 1; CreateUserTo newUserTo = new CreateUserTo("79999999999", "qwe@asd.re",
     * "fname", "sname", "pname", "city", "street", "house", "building",
     * "apartment", "USER", otPass + "");
     * 
